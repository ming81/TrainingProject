...
namespace Mewlist.MassiveClouds
{
    ...
    public class MassiveCloudsPhysicsCloud : AbstractMassiveClouds
    {
        ...
        public override void BuildCommandBuffer(CommandBuffer commandBuffer, Camera targetCamera, RenderTargetIdentifier source, IFullScreenDrawable fullScreenDrawer)
        {
            ...
            var renderTextures = new FlippingRenderTextures(targetCamera, BufferTextureFormat, commandBuffer, TextureScaleFromQualitySetting);
            commandBuffer.SetGlobalTexture("_ScreenTexture", source);
            physicsCloudPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
            layeredCloudPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
            atmospherePass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
