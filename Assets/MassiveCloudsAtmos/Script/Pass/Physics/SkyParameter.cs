...
namespace Mewlist.MassiveClouds
{
    ...
    public class SkyParameter
    {
        ...
        public SkyParameter(float skyExposure, float groundScattering, Color groundColor, float sunSize, float sunSizeConvergence, float saturation, float atmosphereThickness, float gradation)
        {
