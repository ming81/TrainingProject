    ...
    public class MassiveCloudsPass : IMassiveCloudsPass<MassiveCloudsStylizedCloud>
    {
        ...
        public void BuildCommandBuffer(MassiveCloudsStylizedCloud context, Camera targetCamera, CommandBuffer commandBuffer, FlippingRenderTextures renderTextures)
        {
            ...
            for (var i = 0; i < context.Profiles.Count; i++)
            {
                ...
                commandBuffer.Blit(renderTextures.From, renderTextures.LowResolutionTmpId, material);
                commandBuffer.Blit(renderTextures.LowResolutionTmpId, renderTextures.To, m.Material.MixMaterial);
