...
namespace Mewlist.MassiveClouds
{
    ...
    public class MassiveCloudsStylizedCloud : AbstractMassiveClouds
    {
        ...
        public override void BuildCommandBuffer(CommandBuffer commandBuffer, Camera targetCamera, RenderTargetIdentifier source, IFullScreenDrawable fullScreenDrawer)
        {
            ...
            shadowPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
            fogPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
            cloudsPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
            volumetricShadowPass.BuildCommandBuffer(this, targetCamera, commandBuffer, renderTextures);
