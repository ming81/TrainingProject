...
namespace NWH.VehiclePhysics2.Sound.SoundComponents
{
    ...
    public class BlinkerComponent : SoundComponent
    {
        ...
        public override void SetDefaults(VehicleController vc)
        {
            ...
            {
                AudioClip blinkerOn =
                    Resources.Load(VehicleController.defaultResourcesPath + "Sound/BlinkerOn") as AudioClip;
                if (blinkerOn == null)
                {
                    Debug.LogWarning(
                ...
                AudioClip blinkerOff =
                    Resources.Load(VehicleController.defaultResourcesPath + "Sound/BlinkerOff") as AudioClip;
                if (blinkerOff == null)
                {
                    Debug.LogWarning(
                        $"Audio Clip for sound component {GetType().Name} could not be loaded from resources. Source will not play.");
