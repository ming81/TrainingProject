...
namespace NWH.NPhysics
{
    ...
    public class NRigidbody : MonoBehaviour
    {
        ...
        {
            get { return substeps; }
            set { _tmpSubsteps = value < 1 ? 1 : value > 30 ? 30 : value; }
        }
        ...
        private void Step()
        {
            ...
            // Apply velocity
            nRotation = Quaternion.Euler(angularVelocity * (Mathf.Rad2Deg * dt)) * nRotation;
        ...
        public void SyncAllFromTarget()
        {
            ...
            _invMass      = 1f / mass;
            _invInertia.x = 1f / inertia.x;
            _invInertia.y = 1f / inertia.y;
            _invInertia.z = 1f / inertia.z;
        }
